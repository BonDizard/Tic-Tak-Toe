import '../home_light_three_screen/widgets/homelightthree_item_widget.dart';
...
class HomeLightThreeScreen extends GetWidget<HomeLightThreeController> {
  HomeLightThreeScreen({Key? key})
      : super(
          key: key,
        );
      ...
      child: Padding(
        ...
        child: Obx(
          () => ListView.separated(
            ...
            itemCount: controller.homeLightThreeModelObj.value
                .homelightthreeItemList.value.length,
            itemBuilder: (context, index) {
              HomelightthreeItemModel model = controller.homeLightThreeModelObj
                  .value.homelightthreeItemList.value[index];
              return HomelightthreeItemWidget(
                model,
              );
            },
          ),
