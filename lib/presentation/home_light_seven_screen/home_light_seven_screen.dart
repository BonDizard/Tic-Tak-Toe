import '../home_light_seven_screen/widgets/homelightseven_item_widget.dart';
...
class HomeLightSevenScreen extends GetWidget<HomeLightSevenController> {
  HomeLightSevenScreen({Key? key})
      : super(
          key: key,
        );
      ...
      child: Padding(
        ...
        child: Obx(
          () => ListView.separated(
            ...
            itemCount: controller.homeLightSevenModelObj.value
                .homelightsevenItemList.value.length,
            itemBuilder: (context, index) {
              HomelightsevenItemModel model = controller.homeLightSevenModelObj
                  .value.homelightsevenItemList.value[index];
              return HomelightsevenItemWidget(
                model,
              );
            },
          ),
